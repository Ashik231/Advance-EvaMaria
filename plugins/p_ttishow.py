        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://te.legra.ph/file/947ffdff12fc600c17e26.jpg",                                               
                                                 caption=f'<b>👋𝘏𝘦𝘺 {u.mention}, 𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘛𝘰 {message.chat.title} അങ്ങനെ അവസാനം നിങ്ങൾ എത്തേണ്ട സ്ഥലത്ത് എത്തി😸,ഇവിടെ നിങ്ങൾക്ക് വേണ്ട എല്ലാ സിനിമയും കിട്ടും, അങ്ങനെ കിട്ടുന്നില്ലെങ്കിൽ മുതലാളിയോട് പറഞ്ഞാൽ മതി...</b>',
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('♡മുതലാളി♡', url='https://t.me/Unavailable4allTime') ] ] )
                )
