...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        ...
        await asyncio.sleep(2) # 😢 https://github.com/Ashik231/Advance-EvaMaria/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "𝘕𝘦𝘸 𝘔𝘰𝘷𝘪𝘦𝘴📌", url=invite_link.invite_link
                )
            ]
        ]
...
async def delete(bot, message):
    ...
    if result.deleted_count:
        ...
        if result.deleted_count:
            ...
            # files indexed before https://github.com/Ashik231/Advance-EvaMaria/commit/f3d2a1bcb155faf44178e5d7a685a1b533e714bf#diff-86b613edf1748372103e94cacff3b578b36b698ef9c16817bb98fe9ef22fb669R39 
